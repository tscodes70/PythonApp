...
CLEANERCUSTOMFILE = "Datafiniti_Hotel_Reviews(2002-2019).csv"
CLEANERCUSTOMFULLFILE = os.path.join(CSVD,CLEANERCUSTOMFILE)
...
# Analysis Variables
ANALYSISINPUTFULLFILE = MDOUTPUTFULLFILE
...
GREVIEWS_SUMMARY = 'good.reviews.summary'
BREVIEWS_SUMMARY = 'bad.reviews.summary'
...
CORRFILE = f"correlation_{CURRENTDATE}.csv"
CORRFULLFILE = os.path.join(CSVD,CORRFILE)
CORRVARIABLE = "variable"
CORRCOEFFICIENT = "correlation.coefficient"

ANALYSISOUTPUTHEADER = [NAME, PROVINCE, POSTALCODE,CATEGORIES,PRIMARYCATEGORIES, COMPOUND_SENTIMENT_SCORE, GREVIEWS_SUMMARY, BREVIEWS_SUMMARY, REVIEWS_TOTAL, POPULAR_KEYWORDS,AVERAGE_RATING,AMENITIES,PRICES]


# Time Analysis
TANALYSISINPUTFULLFILE = ANALYSISREVIEWOUTPUTFULLFILE
...
TANALYSISHOTELCORROUTPUTFILE = f"tanalyzedhotels_{CURRENTDATE}"
TANALYSISHOTELCORROUTPUTFULLFILE =  os.path.join(CSVD,TANALYSISHOTELCORROUTPUTFILE)
TANALYSISNAMECORROUTPUTFILE = f"tanalyzednames_{CURRENTDATE}"
TANALYSISNAMECORROUTPUTFULLFILE =  os.path.join(CSVD,TANALYSISNAMECORROUTPUTFILE)

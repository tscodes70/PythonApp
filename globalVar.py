...
ANALYSISOUTPUTHEADER = [NAME, PROVINCE, POSTALCODE,CATEGORIES,PRIMARYCATEGORIES, COMPOUND_SENTIMENT_SCORE, GREVIEWS_SUMMARY, BREVIEWS_SUMMARY, REVIEWS_TOTAL, POPULAR_KEYWORDS,AVERAGE_RATING,AMENITIES]

...
def main():
    dataFrame = readScrapeCsv(r'C:\Users\anyho\Desktop\PythonProject\csvs\combinedData.csv')
    dataCleaning(dataFrame).to_csv(r"C:\Users\anyho\Desktop\PythonProject\csvs\testing.csv")
